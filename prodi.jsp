...
<div class="row">
    <div class="span4">
        <form method="post" action="prodi.jsp" class="well">
            ...
            <fieldset>
                ...
                <% if("delete".equals(actForm)){ %>
                    ...
                    <span class="input-block-level uneditable-input"><%=varUtil.show(jObj.nama)%></span>
                <% }else{ %>
                    <select name="kode_jenjang" class="input-block-level">
                ...
                <div style="margin-top: 20px;">
                    ...
                    <a href="prodi.jsp" class="btn">Reset</a>
                </div>
            </fieldset>
        </form>
    </div>
